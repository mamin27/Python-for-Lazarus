...
{ TSortThread }
  ...
  public
    ...
    constructor Create( AThreadExecMode: TThread; script: TStrings;
...
constructor TSortThread.Create( AThreadExecMode: TThread; script: TStrings;
                                module: TPythonModule; apyfuncname: string;
                                Box: TPaintBox; var SortArray: array of Integer);
begin
